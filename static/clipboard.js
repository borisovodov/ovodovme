...
var authOff = document.getElementById("authOff")
var authOn = document.getElementById("authOn")
...
function showAuth() {
  authOff.style.display = "none"
  authOn.style.display = "inline-block"
}

function hideAuth() {
  authOff.style.display = "inline-block"
  authOn.style.display = "none"
}
