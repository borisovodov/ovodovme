	...
	return (
		<>
			...
			*/}
				...
				<p className="mt-2">Самый центр, вокруг которого вырос сначала Екатеринский завод, а потом и весь город. Все дороги ведут сюда, так что даже если не будете планировать тут оказаться — всё равно появитесь. Здесь всегда джемят музыканты, а дедульки играют в шахматы у перехода. Екатеринбург как он есть.</p>
				<p className="font-bold mt-8">
					<Location
			...
			*/}
				...
				<p className="mt-2">Лучший частный музей города. Большое собрание Ройзмана уникальных икон нашей области. Уникальная атмосфера, будто вот-вот и запахнет ладаном.</p>
				<p className="font-bold mt-8">
					<Location
