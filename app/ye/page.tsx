...
export default function YePage() {
	...
	return (
		<div className="p-8">
			...
			<div className="max-w-2xl">
				<p className="text-lg mt-8">От <Link variant="yekaterinburg" href="/">автора</Link></p>
			...
			*/}
				...
				{/*
			<p className="font-bold mt-4"><Link variant="yekaterinburg" href="https://kitchen23.org">Китчен</Link> на <span className="modern">Ткачей</span><span className="auth">Расторгуевской</span>, 23</p>
			...
			*/}
				...
				<p className="mt-4">Вообще не люблю это здание в его нынешнем сталинско-ампирском обличии. Но помню, что под капотом у него <Link variant="yekaterinburg" href="/190617_original.jpg">вот такая</Link> конструктивистская красота.</p>
				<p className="font-bold mt-4">
					<Location
			...
			*/}
				...
				<ol>
					<li>Там находится <Link variant="yekaterinburg" href="https://ru.wikipedia.org/wiki/Шигирский_идол">Шигирский идол</Link> — самая древняя в мире деревянная скульптура. 12 000лет деревяшке.</li>
				...
				<p className="mt-4">Никита Корытин, директор музея ИЗО, однажды <Link variant="yekaterinburg" href="https://podcasts.apple.com/ru/podcast/%D0%BC%D0%B5%D1%81%D1%82%D0%BD%D1%8B%D0%B5/id1550641240?i=1000575333935">высказал мнение</Link>, что екатеринбуржцам в поискам самости не надо себя обманывать и притворяться теми, кем мы не являемся. Идентичность Екатеринубрга — это камень, геология и металлургия. И всё, не надо больше ничего выдумывать. Музей при Уральском горном университете — это 4 этажа кристаллизованной идентичности.</p>
				{/*
			<p>Карта объектов Тимы Ради</p>
			<p></p>
			<p className="font-bold mt-4"><Link variant="yekaterinburg" href="https://m-i-e.ru/mie-filial">Музей истории Екатеринбурга</Link> на <span className="modern">Карла Либкнехта</span><span className="auth">Вознесенском проспекте</span>, 26</p>
