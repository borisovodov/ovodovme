	...
	return (
		<div className="p-8">
			...
			<div className="max-w-2xl">
				...
				<p className="mb-2">Живу в Екатеринбурге всю свою жизнь и люблю его. Хочется поделиться своим взглядом на город для ребят, которые оказались тут проездом.</p>
				<p className="mb-2">Путеводитель очень субъективный и не ставит своей целью охватить все классные точки на карте. Он только про точку зрения автора. Путеводитель не для жителей. У каждого из нас свой Екатеринбург и вы лучше меня знаете <i>те самые</i> ваши места.</p>
				<p className="mb-2">А теперь просто выбирайте понравившиеся вам места, вбивайте адрес в карты на телефоне и идите туда пешком. Город у нас маленький, тем более центр.</p>
				{/*
				...
				*/}
				...
				<p>Гранджевая кофейня для задротов. Разные фильтры на выбор с бесплатным пополнением — купил чашку и дегустируешь все сорта. Приятная, необычная еда. Будете там, передавайте привет Лёне и Диме.</p>
				<p>А ещё владелец кофейни однажды захотел создать самые крутые кофейные чашки в мире. На сысертском фарфоровом заводе (Сысерть — пригород Екатеринбурга) ему реально сделали такие. Прикупите себе в подарок, продаются в разных цветах.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Симпл Кофи"
						onNameChange={setName}
				...
				<p>Первое место, открывшееся с прицелом на завтраки. Правильно произносить не «Энджелс», а «Энгельс», потому что первое кафе бренда находилось на улице <OriginaledTitle modern="Энгельса" original="Малаховской (позже Энгельса)" isOriginal={isOriginal} />. Но его там уже нет, а вот на <OriginaledTitle modern="Малышева" original="Покровском проспекте" isOriginal={isOriginal} /> посидеть — отлично, когда никуда с утра не торопишься. Основа меню — вафли — правда кайфовые.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Брэдвэй"
						onNameChange={setName}
				...
				<p>Сомневался куда относить «Брэдвэй» и «Горожане» — в ужины или завтраки. Отнёс сюда, потому что работают с утра. Еда потрясающая и не только на завтраки, интерьер в стиле «дорого-богато, но без приторности». Нормальный такой ресторан, инстаграмабельно.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Горожане"
						onNameChange={setName}
				...
				<p>Внимание: так как место прекрасное, по утрам туда набивается толпа народа и бывает, что столики на завтраки забронированы на пару дней вперёд. Запаривайтесь заранее.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Муру"
						onNameChange={setName}
				...
				<p>Прекрасные десерты, знаменитые на весь город. Многие закупают у них на перепродажу. Но мест очень мало, редко так везёт, что удастся в выходные посидеть. Можете попытать счастья и приехать пораньше.</p>
				{/* 
			<p className="font-bold mt-4 mb-2"><a className="ye" href="https://www.instagram.com/papacarlocoffee/">Папа Карло</a> на <OriginaledTitle modern="Малышева" original="Покровском проспекте" isOriginal={isOriginal} />, 47а</p>
			...
			<p className="font-bold mt-4 mb-2"><a className="ye" href="https://breakfastunit.one">Брэкфэст Юнит</a> на <span className="modern">Банковском</span><span className="auth">Торговой</span>, 8</p>
			<p>Ещё одно крохотное место для завтраков. Внутри всё классно, находится в самом центре, но сложно найти посадочные места.</p>
			<p className="font-bold mt-4 mb-2"><a className="ye" href="https://1991.rest/">1991</a> в Ельцин Центре на <span className="modern">Ельцина</span><span className="auth">Фетисовской</span>, 3</p>
			...
			*/}
				...
				<p>Это основа. Это, так сказать, база. Приехали в Екатеринбург и не знаете где поужинать? Идите в «Гастроли»! Это одно из самых титулованных заведений в городе.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Момо"
						onNameChange={setName}
				...
				<p>Вечный конкурент «Гастролей» за право самого награждённого екатеринбургского ресторана. Прекрасная пан-азиатская кухня. Но самое главное... местные вагаси моти. Обязательно возьмите их на десерт. И с собой ещё захватите порцию.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Барборис"
						onNameChange={setName}
				...
				<p>Представьте, что вы Владимир Познер в командировке в Екатеринбурге. Куда вы пойдёте на ужин? Конечно же в «Барборис»! Это тот самый ресторан, где ты развалившись в кресле и держа меню без картинок представляешь себя героем бондианы. Лучшая русская кухня в городе.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Зверобой"
						onNameChange={setName}
				...
				<p>Средиземноморский ресторан с заявкой на одну звезду Мишлена. Души мало, но выебонисто и претенциозно. Если вы москвич, что не выходит за границы Садового кольца, — вам только сюда.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Чаща"
						onNameChange={setName}
				...
				<p>Хорошая русская кухня, приятный интерьер. Про него мало знают местные, поэтому всегда есть места. На завтраках подают шампанское. Кутёж!</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Главный"
						onNameChange={setName}
				...
				<p>Единственный приличный гастромолл. Там нет посредственных заведений, сплошной восторг. Недельную командировку можно там провести не вылазя и пробуя всё время что-то новое. Всех резидентов перечислять не буду, выбирайте сердцем.</p>
				{/*
			<p className="font-bold mt-4 mb-2"><a className="ye" href="https://kitchen23.org">Китчен</a> на <span className="modern">Ткачей</span><span className="auth">Расторгуевской</span>, 23</p>
			...
			<p className="font-bold mt-4 mb-2"><a className="ye" href="https://креветкибургеры.рф">Креветки и Бургеры</a> на <span className="modern">Хохрякова</span><span className="auth">Тихвинской</span>, 25</p>
			<p>Лучшие бургеры в городе по мнению автора.</p>
			<p className="font-bold mt-4 mb-2"><a className="ye" href="https://vk.com/pushkina4neobistro">Пушкина 4</a> на <i><span className="modern">Пушкина</span><span className="auth">Пушкинской</span>, 4</i></p>
			...
			*/}
				...
				<p>В баре так мало места, что быстро вырабатывается навык проноса наливочек через локти, спины и ключицы других людей. Внутри долбят известные в городе диджеи, а 90% посетителей тусят на улице, потому что внутри уже нет свободного миллиметра. Легенда, не иначе. Берите сразу сет наливок, не прогадаете.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Самоцвет"
						onNameChange={setName}
				...
				<p>Очень атмосферное и популярное заведение. Всё время всякие движухи проходят. ЧГК пизже, чем по Первому.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Секта"
						onNameChange={setName}
				...
				<p>Шикосный винный бар, где всё написано на богатом. Очень изысканная кухня, очень профессиональный персонал.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Био Шмио"
						onNameChange={setName}
				...
				<p>Винный бар здорового человека. Иногда официанты снобы, иногда лапушки, это как повезёт. А с вином повезёт в любом случае.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Нельсон Совин"
						onNameChange={setName}
				...
				<p>Самый задротский пивной бар. Для ценителей — сюда.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Джоуз Спот"
						onNameChange={setName}
			...
			*/}
				...
				<p>Легендарный городской продуктовый, из-за которого тут никак не может закрепиться «Вкусвилл». Обязательно посетите, оливье с говядиной там божественный. И онигири тоже. И блинчики с творогом. Ну вы поняли, да?</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Пицца Мия (в девичестве «Фридей») открылась, когда в городе ещё не было ни одного Макдоналдса. И что же теперь — Макдоналдса <i>уже</i> нет, а Пицца Мия всё равно на месте. Если хотите вкусить настоящее уральское студенчество, закажите пиццу «Фридей», соус «Уральский» и Балтику тройку.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Нигора"
						onNameChange={setName}
				...
				<p>Узбечка, про которую наслышаны даже москвичи. Порции размером с голову, жир плавает в жире, меню не менялось с момента открытия (и слава богу). Узбечка же, ну.</p>
				<p className="font-bold mt-4 mb-2">Кировские булочки с корицей в <Location
						name="Кировский"
						onNameChange={setName}
				...
				<p>Их запах — это запах детства. Их вкус — это вкус первой влюблённости в детском саду. Их вид — это красота уральских гор с верхней Таганайской тропы. Заходите в «Кировский» и забирайте одноимённые свежие тёплые булочки с собой в дорогу.</p>
				<p className="text-lg mt-8">Где прогуляться? Где на пробежку выйти?</p>
				<p className="font-bold mt-4 mb-2">Набережная <Location
						name="Городской пруд"
						onNameChange={setName}
				...
				<p>Хиреющий год от года парк с прекрасной ротондой. Главные открыточные виды города.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Сквер у Драмы"
						onNameChange={setName}
				...
				<p>Он же «Октябрьская площадь». Он же «на Драме». Он же «#сквернаш». Тот самый сквер, который отстояли горожане в противоборстве с крупнейшими промышленниками и областными властями. От этого зелень в парке ещё ценнее нашим сердечкам.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Дендропарк"
						onNameChange={setName}
				...
				<p>Милый парк в стороне от центра с прудиками, утками и кучей дивных растений. Вокруг Втузгородок — уютный, старый и спокойный район при крупнейшем университете. Гулять там одно удовольствие.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Улица Горького"
						onNameChange={setName}
				...
				<p>Приятный прогулочный бульвар с прилежащим парком, который сотни лет назад соединял два отдельных населённых пункта / завода. Сейчас это даже не бросается в глаза.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Улица Бажова"
						onNameChange={setName}
				...
				<p>Крупнейшее озеро в округе городской черты (<i>стон зависти в сторону челябинцев</i>). Хорошая инфраструктура, велосипедные дорожки почти опоясывают водоём, много беседок. Тупо кайф. Также недалеко от южной стороны есть Каменные палатки — небольшие скалы, по которым приятно полазать.</p>
				<p className="font-bold mt-4 mb-2">Набережная <Location
				...
				<p>Вид на пруд и мартеновские печи одного из крупнейших уральских заводов. Включайте в наушниках «<a className="text-[#D2E4D6] hover:text-white cursor-pointer underline" href="https://www.youtube.com/watch?v=HrNmLWtlWtY">Екатеринбюргер</a>» Курары и чувствуйте дух нашего сурового края.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Уктусские горы"
						onNameChange={setName}
				...
				<p>Зимой здесь единственное место в городе, где можно покататься на сноубордах. Летом — очень приятный лесной массив в глуши. Для длительных прогулок, если свободен весь день.</p>
				...
				<p>Самый центр, вокруг которого вырос сначала Екатеринский завод, а потом и весь город. Все дороги ведут сюда, так что даже если не будете планировать тут оказаться — всё равно появитесь. Здесь всегда джемят музыканты, а дедульки играют в шахматы у перехода. Екатеринбург как он есть.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Эклектичный, очень нарядный дом в самом центре. Инстаграмабельно.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Белый дом"
						onNameChange={setName}
				...
				<p>Икона позднесоветского модернизма. В народе здание называется «член партии», <i>сами поймёте почему</i>.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Когда говорят про екатеринбургский конструктивизм, то первым делом вспоминают про эту группу зданий. Десять Ле Корбюзье из десяти. Уже только ради этого архитектурного ансамбля стоит приехать в город.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Белая башня"
						onNameChange={setName}
				...
				<p>Самое потрясающее конструктивистское здание города, <i>ин май хамбл опинион</i>. Стоит приехать на Уралмаш не ради духа Уралмаша, а ради него. А лучше запишитесь на <a className="text-[#D2E4D6] hover:text-white cursor-pointer underline" href="https://tower1929.ru/#rec107922777">экскурсию</a>.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Дом связи"
						onNameChange={setName}
				...
				<p>Он же главпочтамт. Недавно отреставрированное конструктивистское здание, очень характерное для городской застройки 20–30-х годов.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Шикосное здание оперного. Можно погулять в небольшом парке за ним (студенты обычно алкашат там после пар).</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Уже упоминался в рамках прогулки по набережной. Обратите внимание на главное здание — то ли детище конструктивизма 30-х, то ли не существовавшего тогда капрома 90-х. Красота неземная.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Вообще не люблю это здание в его нынешнем сталинско-ампирском обличии. Но помню, что под капотом у него <a className="text-[#D2E4D6] hover:text-white cursor-pointer underline" href="/190617_original.jpg">вот такая</a> конструктивистская красота.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
			...
			*/}
				...
				<p>Казалось бы очередной краеведческий музей, который однако умудряется через устаревшие подходы к музейным нарративам невероятно иммерсивно погрузить в эстетику уральских гор и окружающей природы. Хотите побывать на Конжаковском камне не взбираясь на него — сходите сюда.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Лучший частный музей города. Большое собрание Ройзмана уникальных икон нашей области. Уникальная атмосфера, будто вот-вот и запахнет ладаном.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Ещё одна коллекция Ройзмана, которую он передал городским властям. Уютный приятный музей близкого нам с вами искусства.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Синара Центр"
						onNameChange={setName}
				...
				<p>Одна из первых в городе галерей современного искусства, которая ранее размещалась в другом здании, а в 2019-м переехала в этот прекрасно отреставрированный бывший госпиталь Верх-Исетского завода. Хорошая коллекция, постоянные разноплановые выставки.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Всем ценителям брутализма посвящается.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Отличный частный музей с богатым собранием московского, питерского и екатеринбургского андеграундного искусства. В наличии даже Пригов, Кабаков и Новиков.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>В целом посредственный краеведческий музей, хоть и крупнейший в городе, если бы не три но.</p>
				<ol>
				...
				<p>Наш главный художественный музей. На Воеводина только русское искусство.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Дом Метенкова"
						onNameChange={setName}
				...
				<p>Фотографический музей в котором всегда отличные выставки.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Здесь выставляется <i>то самое</i> современное искусство, которое не понимают твои родители. Культовая институция, которая одной из первых начала прокачивать в городе тему уличного искусства и приучать жителей к современному. Честь и хвала ребятам.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
			...
			*/}
				...
				<p className="font-bold mt-4 mb-2">Местный стрит-арт</p>
				...
				<p>Знаменитый эксцентричный театр, безумная уральская цыганщина. Это одна из тех вещей, которые либо безумно нравятся, либо совсем нет. Автору знакомы обе категории людей.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
				...
				<p>Очень андеграундные ребята. Находятся в пикулях и чтобы понять где на этой промзоне театр, у них на сайте есть большая инструкция. Но этот поиск стоит того, постановки прекрасные.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Эвер Джаз"
						onNameChange={setName}
				...
				<p>Приятный джазовый клуб. Почти каждый день какие-нибудь выступления. Очень спокойная <i>своя</i> атмосфера.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Филармония"
						onNameChange={setName}
				...
				<p>Филармония у нас классная, «питерские бабушки» в наличии.</p>
			{/* 
			<p className="font-bold mt-4 mb-2">Сходить на женский баскетбол и поболеть на домашних матчах за «УГМК» в <a className="ye" href="https://divsport.ru">ДИВСе</a> на <span className="modern">Олимпийской набережной</span><span className="auth">Ключевской</span>, 3</p>
			...
			<p className="font-bold mt-4 mb-2">Скалодром <a className="ye" href="https://kraisveta.com">Край Света</a> в «Силе Воли» на Толмачёва, 22</p>
			...
			*/}
				...
				<p>За сувенирами с Урала сюда. Куча приятных памятных штучек, особенно ценно варенье из кедровых шишек.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Золотое яблоко"
						onNameChange={setName}
				...
				<p>Самый крутой в стране магазин парфюмерии и косметики вообще-то родом из Екатеринбурга. Загляните в штаб.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Инжир"
						onNameChange={setName}
				...
				<p>Лучший в городе цветочный магазин. То самое место, чтобы порадовать дорогих сердцу людей.</p>
				<p className="font-bold mt-4 mb-2">
					<Location
						name="Пиотровский"
						onNameChange={setName}
				...
				<p>Наш крутейший книжный. Как «Фаланстер» и «Подписные издания», только «Пиотровский».</p>
				<p className="text-lg mt-8">На прощание</p>
				<p className="mb-2">Хотите побольше истории? Налейте чаю с жжёным «Свердловским» кексом и прочитайте «<a className="text-[#D2E4D6] hover:text-white cursor-pointer underline" href="https://www.goodreads.com/book/show/22031637">Ёбург</a>» Алексея Иванова.</p>
				<p className="mb-2">А вообще, расслабьтесь относительно ожиданий. Если вам слащаво и уютно, значит что-то идёт не так. Как говорила легендарная <a className="text-[#D2E4D6] hover:text-white cursor-pointer underline" href="https://t.me/ekbprogulki">Васильева</a>: «Урал — место не для жизни, а для работы».</p>
				<p className="mb-2">За помощь в составлении путеводителя и редактуру спасибо Ане, Саше и Маше.</p>
				<Signature />
				<LocationModal
					isOpen={isOpen}
