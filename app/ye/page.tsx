		...
		<div className="p-8">
			...
			<div className="max-w-2xl">
				...
				*/}
				...
				<p className="mt-4">Тоже ресторан с хорошей кухней, но работает с 8:30, что делает его идеальным местом для завтраков. Если на улице лето, то на десерт заказывайте «Митькину радость» — чувствами улетите в деревню к бабушке, как от <Link href="https://ru.wikipedia.org/wiki/Мадлен_(печенье)#«Мадленка»_Пруста">«Мадленки» Пруста</Link>.</p>
				...
				{/* 
			<p className="font-bold mt-4"><Link href="https://www.instagram.com/papacarlocoffee/">Папа Карло</Link> на <OriginaledTitle modern="Малышева" original="Покровском проспекте" isOriginal={isOriginal} />, 47а</p>
			...
			<p className="font-bold mt-4"><Link href="https://breakfastunit.one">Брэкфэст Юнит</Link> на <span className="modern">Банковском</span><span className="auth">Торговой</span>, 8</p>
			<p>Ещё одно крохотное место для завтраков. Внутри всё классно, находится в самом центре, но сложно найти посадочные места.</p>
			<p className="font-bold mt-4"><Link href="https://1991.rest/">1991</Link> в Ельцин Центре на <span className="modern">Ельцина</span><span className="auth">Фетисовской</span>, 3</p>
			...
			*/}
				...
				{/*
			<p className="font-bold mt-4"><Link href="https://kitchen23.org">Китчен</Link> на <span className="modern">Ткачей</span><span className="auth">Расторгуевской</span>, 23</p>
			...
			<p className="font-bold mt-4"><Link href="https://креветкибургеры.рф">Креветки и Бургеры</Link> на <span className="modern">Хохрякова</span><span className="auth">Тихвинской</span>, 25</p>
			<p>Лучшие бургеры в городе по мнению автора.</p>
			<p className="font-bold mt-4"><Link href="https://vk.com/pushkina4neobistro">Пушкина 4</Link> на <i><span className="modern">Пушкина</span><span className="auth">Пушкинской</span>, 4</i></p>
			...
			<h3><Link href="https://hmeli.ru">Хмели-Сунели</Link> на Ленина, 69/10</p>
			<p></p>
			...
			*/}
				...
				{/*
			<p className="font-bold mt-4"><Link href="http://new-bar.ru">Нью бар</Link> на <span className="modern">8 марта</span><span className="auth">Уктусской</span>, 8д</p>
			...
			*/}
				...
				<p className="mt-4">Ребята из «Русской медной компании» сначала построили здесь свою штаб-квартиру по проекту Нормана Фостера, а потом причесали и всю улицу вокруг. Теперь это любимое место для прогулок многих горожан. Стоит пройтись по ней от <s>Бивиса и Баттхеда</s> Татищева и де Генина до <Link href="https://ru.wikipedia.org/wiki/Сплавной_мост">сплавного моста</Link>.</p>
				<p className="font-bold mt-4">
					<Location
				...
				<p className="mt-4">Типичный парк культуры и отдыха. Несколько лет назад его причесала и привела в порядок команда <Link href="https://keylman.ru">Кейльман</Link>, с тех пор сильно не плохел. Рядом <i>очень собянинская</i> набережная у Клевер Парка, там тоже стоит погулять.</p>
				<p className="font-bold mt-4">
					<Location
						name="Озеро Шарташ"
						onNameChange={setName}
				...
				<p className="mt-4">Вид на пруд и мартеновские печи одного из крупнейших уральских заводов. Включайте в наушниках «<Link href="https://www.youtube.com/watch?v=HrNmLWtlWtY">Екатеринбюргер</Link>» Курары и чувствуйте дух нашего сурового края.</p>
				<p className="font-bold mt-4">
					<Location
						name="Уктусские горы"
						onNameChange={setName}
				...
				<p className="mt-4">Самое потрясающее конструктивистское здание города, <i>ин май хамбл опинион</i>. Стоит приехать на Уралмаш не ради духа Уралмаша, а ради него. А лучше запишитесь на <Link href="https://tower1929.ru/#rec107922777">экскурсию</Link>.</p>
				<p className="font-bold mt-4">
					<Location
						name="Дом связи"
						onNameChange={setName}
				...
				<p className="mt-4">Вообще не люблю это здание в его нынешнем сталинско-ампирском обличии. Но помню, что под капотом у него <Link href="/190617_original.jpg">вот такая</Link> конструктивистская красота.</p>
				<p className="font-bold mt-4">
					<Location
				...
				{/* 
			<p><Link href="https://ru.wikipedia.org/wiki/Храм_на_Крови_(Екатеринбург)">Храм на Крови ???</Link></p>
			<p></p>
			*/}
				...
				<ol>
					<li>Там находится <Link href="https://ru.wikipedia.org/wiki/Шигирский_идол">Шигирский идол</Link> — самая древняя в мире деревянная скульптура. 12 000лет деревяшке.</li>
				...
				<p className="mt-4">Никита Корытин, директор музея ИЗО, однажды <Link href="https://podcasts.apple.com/ru/podcast/%D0%BC%D0%B5%D1%81%D1%82%D0%BD%D1%8B%D0%B5/id1550641240?i=1000575333935">высказал мнение</Link>, что екатеринбуржцам в поискам самости не надо себя обманывать и притворяться теми, кем мы не являемся. Идентичность Екатеринубрга — это камень, геология и металлургия. И всё, не надо больше ничего выдумывать. Музей при Уральском горном университете — это 4 этажа кристаллизованной идентичности.</p>
				{/*
			<p>Карта объектов Тимы Ради</p>
			<p></p>
			<p className="font-bold mt-4"><Link href="https://m-i-e.ru/mie-filial">Музей истории Екатеринбурга</Link> на <span className="modern">Карла Либкнехта</span><span className="auth">Вознесенском проспекте</span>, 26</p>
			<p>Не самый впечатляющий музей, но хорошо разложит в голове по полочкам основную информацию о городе.</p>
			<p className="font-bold mt-4"><Link href="https://i-z-o.art/constitutor/centr-ermitazh-ural/">Эрмитаж-Урал</Link> на <span className="modern">Вайнера</span><span className="auth">Успенской</span>, 11</p>
			...
			*/}
				...
				<p className="mt-4">Про бесчисленное количество работ в городе можно рассказывать бесконечно, просто сходите на одну из экскурсий <Link href="https://www.instagram.com/shakhov_hell/">Лёши Шахова</Link> или прогуляйтесь по карте фестиваля «<Link href="https://stenograffia.ru">Стенограффия</Link>».</p>
				<p className="font-bold mt-4">
					<Location
						name="Коляда-Театр"
						onNameChange={setName}
			...
			{/* 
			<p className="font-bold mt-4">Сходить на женский баскетбол и поболеть на домашних матчах за «УГМК» в <Link href="https://divsport.ru">ДИВСе</Link> на <span className="modern">Олимпийской набережной</span><span className="auth">Ключевской</span>, 3</p>
			...
			<p className="font-bold mt-4">Скалодром <Link href="https://kraisveta.com">Край Света</Link> в «Силе Воли» на Толмачёва, 22</p>
			...
			<p><Link href="https://tele-club.ru/fabrika">Фабрика ???</Link></p>
			...
			*/}
				...
				<p className="mt-4">Хотите побольше истории? Налейте чаю с жжёным «Свердловским» кексом и прочитайте «<Link href="https://www.goodreads.com/book/show/22031637">Ёбург</Link>» Алексея Иванова.</p>
				<p className="mt-4">А вообще, расслабьтесь относительно ожиданий. Если вам слащаво и уютно, значит что-то идёт не так. Как говорила легендарная <Link href="https://t.me/ekbprogulki">Васильева</Link>: «Урал — место не для жизни, а для работы».</p>
