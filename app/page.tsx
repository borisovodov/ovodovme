		...
		<div className="max-w-2xl">
			...
			{/* <Card shadow="sm">
				<CardBody className="text-gray-400">
					Екатеринбург, 17:41, ⛅️
					<br />
					Группа крови? • R1a-M417 (R1a1a1) • Z1a1a
					<br />
					D80B 2855 595A 0BAF FE09  0DC1 03D4 F66F D856 A100
					FQKf8ftw4JTgHeyhzFyL8yj5F64Z4bC7+DJFWuzUn4s
					<br />
					Добиться группу крови, текущий город, погоду в текущем городе, время локальное в текущем городе, Y и mt гаплогруппы, сколько жить осталось, PGP ключ
				</CardBody>
			</Card> */}
			<Tabs fullWidth aria-label="Сферы" size="lg" className="mt-4">
				...
				<Tab key="talks" title="Выступления">
				...
				<Tab key="future" title="Впереди">
					<p className="mt-4">Проведу перфоманс с важными извинениями.</p>
					<p className="mt-4">Сниму документальный фильм про то, как трое ребят ищут свои корни.</p>
					<p className="mt-4">Напишу книгу про Онисима Клера и его семью.</p>
