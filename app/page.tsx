		...
		<div className="max-w-3xl">
			...
			<Tabs fullWidth aria-label="Сферы" size="lg" className="mt-8">
				...
				<Tab key="media" title="Медийка">
					...
					>
						<p>Боря, перепиши своими словами. Изначально:</p>
						<p className="italic">Саша и Боря разговаривают о том, что происходит вокруг. Как выбрать сторону, на которой хочется быть? Как сделать мир, или хотя бы себя, лучше? Как не сойти с ума в этом безумном мире?</p>
					</ProjectCard>
					<ProjectCard
						name="Сайнс, бич"
				...
				<Tab key="past" title="Позади">
					...
					<ProjectCard
						...
						years="2012–2013"
					>
						<p className="italic">Пока сил нет, распишу попозже, что мы учудили с Ильёй, Максимом и Сашей в 2012-м.</p>
					</ProjectCard>
					<ProjectCard
						name="КYБ и Ко"
