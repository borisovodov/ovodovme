		...
		<div className="max-w-3xl">
			...
			<Tabs fullWidth aria-label="Сферы" size="lg" className="mt-8">
				...
				<Tab key="media" title="Медийка">
					...
					>
						Подкаст в котором мы с Сашей разговариваем о том, что происходит вокруг. Как выбрать сторону, на которой хочется быть? Как сделать мир, или хотя бы себя, лучше? Как не сойти с ума в этом безумном мире?
					</ProjectCard>
					<ProjectCard
						name="Сайнс, бич"
