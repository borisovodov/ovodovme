			...
			<Tabs fullWidth aria-label="Сферы" size="lg" className="mt-8">
				...
				<Tab key="talks" title="Паблик токи">
					...
					<TalkCard
						...
						duration="1 час"
					>
						Рассказал как преподавал астрономию по субботам в екатеринбургской 35-й гимназии. Про вдохновение школьников, бумажную работу и изобретение своего подхода к обучению.
					</TalkCard>
					<TalkCard
